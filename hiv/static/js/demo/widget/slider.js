(function() {
  ...
  define(["backbone", "underscore", "common/continuum_view", "common/has_parent", "common/logging", "./slidertemplate", "jquery_ui/slider"], function(Backbone, _, continuum_view, HasParent, Logging, slidertemplate) {
    var ContinuumView, Slider, SliderView, Sliders, logger, _ref, _ref1, _ref2;
