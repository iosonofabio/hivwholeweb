(function() {
  ...
  define(["underscore", "jquery", "jstree", "backbone", "common/continuum_view", "common/has_properties", "common/logging", "source/column_data_source"], function(_, $, $1, Backbone, ContinuumView, HasProperties, Logging, ColumnDataSource) {
