(function() {
  ...
  define(["underscore", "backbone", "jquery", "bootstrap/modal", "common/has_properties", "common/continuum_view", "./dialog_template"], function(_, Backbone, $, $1, HasProperties, continuum_view, dialog_template) {
