(function() {
  ...
  define(["underscore", "backbone", "common/continuum_view", "common/has_parent", "common/build_views", "common/logging"], function(_, Backbone, continuum_view, HasParent, build_views, Logging) {
