(function() {
  ...
  define(["underscore", "backbone", "jquery", "bootstrap/button", "common/continuum_view", "common/has_parent", "common/logging", "bootstrap/button"], function(_, Backbone, $, $1, continuum_view, HasParent, Logging) {
